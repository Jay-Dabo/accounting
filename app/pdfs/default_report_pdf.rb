class DefaultReportPdf < Prawn::Document
  ...
  def header
    ...
    bounding_box [bounds.left, bounds.top], :width  => bounds.width do
        ...
        move_down(5)
        text publish_timestamp, align: :center, size:14
        text "disusun dengan Kapiten, sistem pembukuan tanpa repot", align: :center, size: 14
        text "www.sikapiten.com", align: :center, size: 10, style: :italic
  ...
  # def row_colors_array
  #   ['F0FFF0', 'FFFFFF']
  # end

  def to_idr(number)
    @view.idr_money(number)
  end
