...
ActiveRecord::Schema.define(version: 20150214141608) do
  ...
  add_index "purchases", ["date", "firm_id"], name: "index_purchases_on_date_and_firm_id", using: :btree
  add_index "purchases", ["date"], name: "index_purchases_on_date", using: :btree
  ...
  add_index "sales", ["date", "firm_id"], name: "index_sales_on_date_and_firm_id", using: :btree
  add_index "sales", ["date"], name: "index_sales_on_date", using: :btree
